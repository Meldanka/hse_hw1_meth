...
# Часть 1
Сравниваем fastqc report для BS-seq 8cell с fastqc report для RNA-seq SRR3414629_1 из прошлого дз3 (https://github.com/Meldanka/hse21_hw3).
<p float="left">
...
<p float="left">
 ...
 <img width="1174" alt="Снимок экрана 2022-02-18 в 15 24 33" src="https://user-images.githubusercontent.com/91221560/154730277-55319a38-374a-42b1-a7c3-5bd4f7707f0c.png">
</p>
...
Подводя итоги всему проделанному анализу, мы убедились, что на ранних стадиях CpG метилирование уменьшается до некоторого минимума, а затем по мере дифференцировки тканей, сильно увеличивается и стабилизируется.
